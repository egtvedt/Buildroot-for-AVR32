...
QTOPIA4_VERSION:=4.4.0-snapshot-20080219
QTOPIA4_CAT:=$(BZCAT)
...
QTOPIA4_SOURCE:=qtopia-core-commercial-src-$(QTOPIA4_VERSION).tar.bz2
...
QTOPIA4_SOURCE:=qtopia-core-opensource-src-$(QTOPIA4_VERSION).tar.bz2
